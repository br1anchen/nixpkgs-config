Read the installed runtime adapter at `~/.agents/skills/pstack/references/runtime.md` before following this workflow. Its runtime mappings apply to all referenced playbooks and scripts.
