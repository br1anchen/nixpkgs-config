...
{{Questions the sidekick should answer from the code and the consultant from
the design, or "none".}}

## Disagreements resolved

{{Round 2 onward: each objection from the previous sidekick response and
consultant advice, and how this round answers it, adopted or declined with the
reason. "none" in round 1.}}
